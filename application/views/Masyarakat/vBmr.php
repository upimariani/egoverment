    ...
    <div class="container text-center py-5">
        ...
        <nav aria-label="breadcrumb animated slideInDown">
            <ol class="breadcrumb justify-content-center mb-0">
                ...
                <li class="breadcrumb-item"><a href="#">Surat Keterangan Belum Memiliki Rumah</a></li>
            </ol>
        </nav>
    </div>
</div>
    ...
    <div class="container">
        <div class="row g-5">
            <div class="col-lg-12 wow fadeIn" data-wow-delay="0.1s">
                ...
                <h1 class="display-5 mb-5">Keterangan Belum Memiliki Rumah</h1>
                <?php
                ...
                ?>
                <p class="mb-4">Silahkan mengisi data pengajuan surat keterangan belum memiliki rumah</p>
                <form action="<?= base_url('Masyarakat/cBmr/daftar/' . $domisili->id_masyarakat) ?>" method="POST">
                    <div class="row g-3">
                        <div class="col-md-6">
