...
INSERT INTO `belum_kawin` (`id_kawin`, `id_masyarakat`, `tgl_pengajuan_kawin`, `no_surat_kawin`, `stat_kawin`, `stat_surat`) VALUES
(1, 1, '2022-12-14 17:00:00', '1', 'Belum Kawin', 1);
...
INSERT INTO `blm_mmlk_rumah` (`id_rumah`, `id_masyarakat`, `tgl_pengajuan_rumah`, `no_surat_rumah`, `stat_rumah`) VALUES
...
INSERT INTO `domisili` (`id_domisili`, `id_masyarakat`, `tgl_pengajuan_dom`, `no_surat_dom`, `create_dom`, `stat_dom`) VALUES
(1, 1, '2022-10-12', '1', '2022-12-11 12:15:33', 1),
(3, 4, '2022-12-13', '2', '2022-12-13 12:47:15', 0);
...
INSERT INTO `kematian` (`id_kematian`, `id_masyarakat`, `tgl_pengajuan_kematian`, `no_surat_kematian`, `tgl_meninggal`, `akibat`, `tempat`, `stat_kematian`) VALUES
(1, 2, '2022-12-14 17:00:00', '1', '15 Desember 202', 'Sakit', 'Rumah', 0),
(2, 1, '2022-12-17 17:00:00', '2', '15 Desember 202', 'Sakit', 'Rumah', 1);
...
INSERT INTO `ket_pindah` (`id_pindah`, `id_masyarakat`, `tgl_pengajuan_pindah`, `no_surat_pindah`, `alasan`, `alamat_tujuan`, `rt`, `rw`, `desa_kel`, `kec`, `kab`, `prov`, `kode_pos`, `jenis_pindah`, `stat_kk_tidak`, `stat_kk_iya`, `type_pindah`, `stat_pindah`) VALUES
...
(4, 0, '3202145698745655', '320987484939342', 'Red Evil', 'Kuningan, 05 April 2022', 'Perempuan', 'Ling. Harapan', '12', '03', 'Kertawana', 'Kalimanggis', 'Islam', 'Menikah', 'Istri', 'Ibu Rumah Tangga', 'Nana', 'Yayan');
...
INSERT INTO `sktm` (`id_sktm`, `id_masyarakat`, `tgl_pengajuan_sktm`, `no_surat_sktm`, `stat_sktm`) VALUES
...
INSERT INTO `sku` (`id_sku`, `id_masyarakat`, `tgl_pengajuan_sku`, `no_surat_sku`, `nama_usaha`, `jenis_usaha`, `stat_usaha`) VALUES
